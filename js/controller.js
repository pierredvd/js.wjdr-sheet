    ...
    function Controller(){
        ...
        var __resources = {
            ...
            spells: [
                ...
                {id:  4,group:"Sort de magie commune (occulte)",name:"Mains molles",diff:4,castduration:"1/2",ingredient:"une goutte d'huile pour lampe (+1)",desc:"Vous forcez le personnage ciblé, se trouvant dans un rayon de 24 mètres (12 cases), à laisser tomber ce qu'il tient dans ses mains.Le sujet peut résister au sort s'il réussit un test de Force Mentale."},
